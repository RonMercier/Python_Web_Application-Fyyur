...
# Models.
#----------------------------------------------------------------------------#
# Created Show, Venue and Artist Models and completed all model relationships and properties. Used the db.create_all function
# to create the database and tables that are associated with the models. 
